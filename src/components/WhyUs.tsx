...
export const WhyUs: React.FC = () => {
  return (
    <section
      id="keunggulan"
      className="py-16 sm:py-24 bg-muted border-b border-border"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16">
          ...
          <p className="text-base text-muted-foreground">
            Kepercayaan dan kepuasan pelanggan adalah prioritas utama dalam
            setiap pengerjaan service AC.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {SITE_CONFIG.whyUs.map((item, index) => (
            <div
              key={index}
              className="bg-background border border-border rounded-2xl p-4 sm:p-6 text-center hover:shadow-sm transition-all"
            >
              <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-sky-50 border border-sky-100 flex items-center justify-center mx-auto mb-4 sm:mb-5">
