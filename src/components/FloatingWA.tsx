...
export const FloatingWA: React.FC = () => {
  return (
    <aside aria-label="WhatsApp Floating Button" className="fixed bottom-6 right-6 z-50">
      <a
        href={getWhatsAppLink('Halo fazzaservice, saya ingin bertanya tentang layanan AC.')}
        target="_blank"
      ...
      >
        <MessageCircle className="w-8 h-8 fill-white text-[var(--color-cta-wa)]" />
      </a>
    </aside>
  );
};
